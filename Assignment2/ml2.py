...
We acquire a validation accuracy of around 95% , which is higher than the accuracy we obtained when training the tiny model from start. When you use pre-trained features, this isn't always the case.
...
The Pre-trained model with precise adjustment has a test accuracy of 90%.
"""